...
const Profile = ({ data }: IProps) => {
  ...
  return ( 
    <div className='w-full'>
      ...
      <div className='bg-gradient-to-r from-purple-500 to-pink-500 flex gap-6 md:gap-10 mb-4 bg-white w-full'>
      ...
      <div>
        <div className='bg-gradient-to-r from-indigo-500 flex gap-10 mb-10 mt-10 border-b-2 border-gray-200 bg-white w-full'>
